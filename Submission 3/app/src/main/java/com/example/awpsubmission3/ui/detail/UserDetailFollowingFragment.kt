...
class UserDetailFollowingFragment: Fragment(R.layout.fragment_ff) {
    private var _binding : FragmentFfBinding? = null
    private val binding get() = _binding!!
    private lateinit var viewModel: UserDetailFollowingViewModel
    ...
    private fun following(){
        ...
        viewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(UserDetailFollowingViewModel::class.java)
        binding.apply {
